...
client_socket.bind(('localhost', 4912))
...
class MATRIX:
    ...
    def pick_row(matrix):
        random_row_index= np.random.randint(0,10)  #랜덤 행 선택
...
with client_socket as cs:
    ...
    cs.sendall(f"클라이언트2 접속완료. 행, 열 전송 대기중".encode('utf-8'))
    ...
    try:
        ...
        while True:
            ...
            if data == "row":
                ...
                logging.info(f"{cli_name}, {mat_info}, {row_num}, {row_data_json}")
